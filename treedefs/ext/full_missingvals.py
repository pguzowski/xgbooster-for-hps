...
def getit(tf):
    df = tf.pandas.df([b'th1',b'transverse',b'opang',b'th2',b'nhits_other_pfps',b'tree_next_vtx_z_min',b'len1',b'tree_next_vtx_y_max',b'nhits1_p0',b'nhits1_p1',b'nhits1_p2',b'trkshw_score1'])
    return getit_df(df)
featmap_vars = {
...
featmap = 'featmaps/featmap_10best_ext.txt'
