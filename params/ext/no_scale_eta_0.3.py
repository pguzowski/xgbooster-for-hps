...
model_params.treedef = 'full_missingvals'
import importlib.util
spec = importlib.util.spec_from_file_location("module_name", "treedefs/ext/%s.py"%model_params.treedef)
...
model_params.name = 'no_scale_eta_0.3'
